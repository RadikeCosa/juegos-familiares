-- Incremento 8.3 — read model de voting/result para get_my_game_state.
--
-- No implementa segunda votacion, guess de palabra, reveal, scoring,
-- scoreboard, nueva ronda, Broadcast ni Realtime de gameplay.
