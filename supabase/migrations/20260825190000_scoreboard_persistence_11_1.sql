-- Incremento 11.1 — persistencia operativa de marcador + fase scoreboard.
--
-- Prepara SessionPlayer.score y GameSession.state = scoreboard.
-- No aplica puntos, no crea NEW_ROUND, no implementa historial, Broadcast,
-- Realtime de gameplay ni UI final de marcador.

alter table public.session_players
  add column score integer not null default 0;

alter table public.session_players
  add constraint session_players_score_check
    check (score >= 0);
