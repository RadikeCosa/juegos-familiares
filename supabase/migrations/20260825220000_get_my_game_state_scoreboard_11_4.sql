-- Incremento 11.4 — read model de marcador y nueva ronda.
--
-- Amplia get_my_game_state() para scoreboard. No cambia scoring,
-- start_next_round(), historial, fin de tanda, estadisticas ni Realtime.
