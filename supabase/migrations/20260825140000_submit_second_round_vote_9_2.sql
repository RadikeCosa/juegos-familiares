-- Incremento 9.2 — submit_round_vote para segunda votacion + resolucion definitiva.
--
-- No implementa read model/UI completa de segunda votacion, scoring,
-- scoreboard, nueva ronda, historial, Round.status, Broadcast ni Realtime.
