-- Incremento 9.3 — read model de empate y segunda votacion.
--
-- Expone candidatos reconstruidos para tie_discussion y voting_second,
-- mantiene voto propio privado por ronda y usa el agregado definitivo de
-- voting_round = 2 cuando la ronda se resolvio despues de segunda votacion.
